/*****************************************************************************
* Filename:          C:\cygwin\home\Blair\gpu2\project\hardware\drivers/matrixmult_v1_00_a/src/matrixmult.h
* Version:           1.00.a
* Description:       matrixmult (new FSL core) Driver Header File
...
*	 input_1    An array of unsigned integers. Array size is 4
...
*    example code (matrixmult_app.c) for details.
*/
