The following files were generated for 'floating_point_v6_1' in directory
C:\cygwin\home\Blair\gpu2\project\matrixmult\

Generate XCO file:
   CORE Generator input file containing the parameters used to generate a core.

   * floating_point_v6_1.xco

C Simulation Generator:
   Please see the core data sheet.

   * floating_point_v6_1/cmodel/floating_point_v6_1_bitacc_cmodel_lin.zip
   * floating_point_v6_1/cmodel/floating_point_v6_1_bitacc_cmodel_lin64.zip
   * floating_point_v6_1/cmodel/floating_point_v6_1_bitacc_cmodel_nt.zip
   * floating_point_v6_1/cmodel/floating_point_v6_1_bitacc_cmodel_nt64.zip

Generate EJava outputs:
   Please see the core data sheet.

   * demo_tb/tb_floating_point_v6_1.vhd

Generate Implementation Netlist:
   Binary Xilinx implementation netlist files containing the information
   required to implement the module in a Xilinx (R) FPGA.

   * floating_point_v6_1.ngc
...
Generate XMDF file:
   ...
   * floating_point_v6_1_xmdf.tcl

Generate ISE project file:
   ISE Project Navigator support files. These are generated files and should not
   be edited directly.

   * floating_point_v6_1.gise
   * floating_point_v6_1.xise

Deliver Readme:
   Readme file for the IP.

   * floating_point_v6_1_readme.txt

Generate FLIST file:
   Text file listing all of the output files produced when a customized core was
   generated in the CORE Generator.

   * floating_point_v6_1_flist.txt
